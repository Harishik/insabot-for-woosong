...
The InsaBot for Woosong team takes the security of this project and its users seriously. Thank you for helping keep it and the people who rely on it safe.
...
- **Email:** `security@example.com` <!-- TODO: replace with a monitored security contact before publishing -->
