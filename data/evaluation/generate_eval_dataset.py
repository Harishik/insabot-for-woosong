...
TOPICS = [
    ...
    ("arrival", "How do I get from Incheon airport to Woosong?", False, "answerable"),
    ...
    ("no_answer", "Does Woosong have a secret reading week next month?", False, "no_answer"),
            ...
            rows.append(
                {
                    ...
                    "expected_answer_rule": "Use retrieved official Woosong sources only; otherwise return the safe fallback.",
                }
            )
    return rows
