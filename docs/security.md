...
- Script-based detection handles common Woosong student languages before falling back to statistical detection.
...
> I could not verify this from the available Woosong University sources. Please contact the relevant office.
