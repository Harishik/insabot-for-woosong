...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Verify PostgreSQL + pgvector readiness for InsaBot.")
...
def run_docker_sql(sql: str) -> str:
    ...
    completed = subprocess.run(
        [docker, "compose", "exec", "-T", "db", "psql", "-U", "insabot", "-d", "insabot", "-t", "-A", "-c", sql],
