...
export default function AdminDashboard() {
  ...
  const [crawlUrl, setCrawlUrl] = useState("https://english.wsu.ac.kr/main/index.jsp");
      ...
      <div className="mx-auto grid max-w-7xl overflow-hidden rounded-2xl bg-white shadow-soft lg:grid-cols-[260px_minmax(0,1fr)]">
        <aside className="bg-brand-900 p-5 text-white">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-extrabold">InsaBot Admin</p>
              <p className="text-xs text-blue-200">{adminUser?.email ?? "WSU AI Assistant"}</p>
            </div>
          </div>
