...
export const attendanceAnswer: AnswerCard = {
  status: "verified",
  confidence: "high",
  title: "You can record attendance using the Woosong Attendance App.",
  summary: "Use your WSU account, choose the correct class, and check in within the allowed time.",
  steps: [
    "Open the Woosong Attendance App.",
    "Log in with your WSU account.",
    "Select your class.",
    "Tap Check-in within the allowed time.",
    "Confirm your attendance."
  ],
  sources: [
    { title: "Woosong Attendance App Info", url: "https://engforeign.wsu.ac.kr/proc/engforeign_event.jsp", lastUpdated: "Live source" },
    { title: "International Student Service Center", url: "https://engforeign.wsu.ac.kr" }
  ],
...
export const gradesAnswer: AnswerCard = {
  ...
  sources: [
    { title: "Academic Affairs", url: "https://english.wsu.ac.kr/page/index.jsp?code=eng0206", lastUpdated: "2026 academic calendar" },
    { title: "Smart Campus Guide", url: "https://english.wsu.ac.kr/main/index.jsp" }
  ],
