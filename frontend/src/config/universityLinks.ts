/**
 * Centralized Woosong University service link configuration.
 *
 ...
 * APIs are provided, services point at public Woosong pages and are marked with
...
export type UniversityService = {
  ...
  url: string;
  /**
   * Optional native app deep link for a future official Woosong app.
...
const WSU_MAIN = "https://www.wsu.ac.kr";
const WSU_EN = "https://english.wsu.ac.kr";
const WSU_INTL = "https://engforeign.wsu.ac.kr";
...
export const universityLinks: Record<UniversityServiceKey, UniversityService> = {
  mainWebsite: {
    ...
    url: WSU_MAIN,
    description: "Official Woosong University website.",
    temporary: false,
    keywords: ["woosong website", "main website", "university website", "wsu website", "homepage", "official site"]
  },
  studentPortal: {
    key: "studentPortal",
  ...
  academicCalendar: {
    ...
    url: `${WSU_EN}/page/index.jsp?code=eng0206`,
